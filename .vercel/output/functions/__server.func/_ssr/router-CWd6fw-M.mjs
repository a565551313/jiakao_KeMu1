...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CWd6fw-M.js
var router_CWd6fw_M_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-DqyKYa_C.css";
var APP_NAME = "极客驾考26版";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "驾驶人科目一考试系统 · 全真模拟 100 题 · 45 分钟"
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-C7dauHNo.mjs");
...
//#endregion
export { getRouter, router_CWd6fw_M_exports as t };
